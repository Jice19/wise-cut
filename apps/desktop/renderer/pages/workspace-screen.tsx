...
/**
 * 工作台 Screen —— Pencil 中 fDidh outer shell 的 React 还原。
 * Hero header / Filter row / Project grid 三段式。
 */
export const WorkspaceScreen = (): JSX.Element => {
    return (
