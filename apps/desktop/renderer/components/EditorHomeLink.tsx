...
export const EditorHomeLink = ({
    ...
    return (
        <a
            href={href}
            aria-label={label}
            className="group relative grid h-[30px] w-[30px] place-items-center rounded-lg bg-[#D97706] text-xs font-black text-white transition-all duration-200 hover:bg-[#D97706] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#F05F73] [app-region:no-drag] [-webkit-app-region:no-drag]"
        >
